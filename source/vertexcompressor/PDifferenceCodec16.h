...
class PDifferenceCodec16 : public VertexCompressionInterface {
...
public:
	...
	PDifferenceCodec16(SharedData* shared)
		: VertexCompressionInterface(shared, "P. Difference Codec 16bit", "_PDC16")
	{}
