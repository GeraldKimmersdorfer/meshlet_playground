...
class DPDifferenceCodec16 : public VertexCompressionInterface {
	...
	struct cpu_temporary_vertex_data {
		...
		uint8_t boneAttributesResolution; // 0, 2, 4
...
public:
	...
	DPDifferenceCodec16(SharedData* shared)
		: VertexCompressionInterface(shared, "Dual P. Difference Codec 16bit", "_DPDC16")
	{}
