...
void PDifferenceCodec16::doCompress(avk::queue* queue)
{
...
void PDifferenceCodec16::doDestroy()
{
	mBoneLUTData.clear();
...
void PDifferenceCodec16::hud_config(bool& config_has_changed)
{
